...
public class AdvancedTurretGyros extends BaseHullMod {
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		if (stats.getVariant().getSMods().contains("turretgyros") || (Global.getSettings().getBoolean("BuiltInSMod") && stats.getVariant().getHullSpec().isBuiltInMod("turretgyros"))) {
			stats.getAutofireAimAccuracy().modifyFlat(id, TARGET_LEADING_BONUS);
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
		if (isForModSpec) {
			...
			tooltip.addPara("S-mod Bonus: %s target leading accuracy for autofiring weapons.", 10f, Misc.getGrayColor(), Misc.getHighlightColor(), "+100" + "%");
			...
			tooltip.addPara("S-mod Bonus: %s target leading accuracy for autofiring weapons.", 10f, Misc.getPositiveHighlightColor(), Misc.getHighlightColor(), "+100" + "%");
			...
			tooltip.addPara("Built-in Bonus: %s target leading accuracy for autofiring weapons.", 10f, Misc.getPositiveHighlightColor(), Misc.getHighlightColor(), "+100" + "%");
