...
public class NavRelay extends BaseHullMod {
	...
	public void advanceInCombat(ShipAPI ship, float amount) {
		...
		if ((ship.getVariant().getSMods().contains("nav_relay") || (Global.getSettings().getBoolean("BuiltInSMod") && ship.getVariant().getHullSpec().isBuiltInMod("nav_relay") && ship.getMutableStats().getMaxSpeed().getPercentStatMod("coord_maneuvers_bonus") != null))) {
                    float bonus = 0f;
