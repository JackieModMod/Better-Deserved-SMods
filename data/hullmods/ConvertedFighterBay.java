...
public class ConvertedFighterBay extends BaseLogisticsHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
		if (isForModSpec) {
			...
			tooltip.addPara("Decreases the ship's deployment points and supply cost to recover from deployment by %s.", 10f, Misc.getGrayColor(), Misc.getHighlightColor(), "-10%");
			...
			tooltip.addSectionHeading("S-mod bonus", Misc.getStoryOptionColor(), Misc.getStoryDarkColor(), Alignment.MID, 10f);
                        tooltip.addPara("Decreases the ship's deployment points and supply cost to recover from deployment by %s.", 10f, Misc.getPositiveHighlightColor(), Misc.getHighlightColor(), "-10%");
