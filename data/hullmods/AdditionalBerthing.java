	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		if (stats.getVariant() != null) {
			mod = Math.max(stats.getVariant().getHullSpec().getMaxCrew() * MIN_FRACTION, mod);
                ...
                if (stats.getVariant().getSMods().contains("additional_berthing") || (Global.getSettings().getBoolean("BuiltInSMod") && stats.getVariant().getHullSpec().isBuiltInMod("additional_berthing"))) {
                    mod *= 2;
                }
	...
	public String getDescriptionParam(int index, HullSize hullSize) {
        ...
        public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
                     if (isForModSpec) {
                             ...
                             return;
                     } else if (ship.getVariant().getSMods().contains("additional_berthing")) {
                     ...
                     } else if (Global.getSettings().getBoolean("BuiltInSMod") && ship.getHullSpec().isBuiltInMod("additional_berthing")) {
