...
public class EfficiencyOverhaul extends BaseLogisticsHullMod {
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		if (stats.getVariant().isCivilian() && (stats.getVariant().getSMods().contains("efficiency_overhaul") || (Global.getSettings().getBoolean("BuiltInSMod") && stats.getVariant().getHullSpec().isBuiltInMod("efficiency_overhaul")))) {
